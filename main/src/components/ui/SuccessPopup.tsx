...
@PudgyInvest perpetual machine keeps printing`;
  ...
  return (
    <div 
      ...
      style={{ backgroundColor: 'rgba(255, 231, 243, 0.9)' }}
      onClick={handleBackdropClick}
    >
      
      {/* Popup content */}
      <div 
        className={`relative bg-[rgba(255, 231, 243, 0.95)] border-2 border-[var(--color-border-accent)] p-8 lg:p-12 max-w-md w-full mx-4 transform transition-all duration-300 ${
          isAnimating ? 'scale-100 translate-y-0' : 'scale-95 translate-y-4'
        }`}
        style={{
          boxShadow: '0 0 50px rgba(253, 206, 219, 0.3)',
        }}
      ...
      >
        ...
        <div className="text-center mb-6">
          <div 
            ...
            style={{
              backgroundColor: 'rgba(253, 206, 219, 0.1)',
              border: '2px solid rgba(253, 206, 219, 0.5)'
            }}
          >
            <span 
        ...
        {/* Subtitle */}
        <p className="text-center text-black text-sm lg:text-base mb-6 font-[family-name:var(--font-martian-mono)]">
        ...
        <div className="text-center mb-6">
          ...
          <div className="text-black text-sm lg:text-base mt-2 font-[family-name:var(--font-martian-mono)]">
            POLLY
          </div>
        </div>
        ...
        <div className="flex justify-center space-x-2 mb-6">
          {[...Array(5)].map((_, i) => (
            <div
              ...
              style={{ 
                backgroundColor: 'rgba(253, 206, 219, 0.6)',
        ...
        <div className="text-center">
          <button
            ...
            style={{
              ...
              border: '1px solid rgba(253, 206, 219, 0.5)',
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle at center, rgba(253, 206, 219, 0.1) 0%, transparent 70%)',
